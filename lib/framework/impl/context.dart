...
import 'package:gluten_freemwork/framework/impl/config_manager.dart';
import 'package:gluten_freemwork/framework/impl/extension_installer.dart';
import 'package:gluten_freemwork/framework/impl/lifecycle.dart';
import 'package:gluten_freemwork/framework/impl/log_manager.dart';
import 'package:gluten_freemwork/framework/impl/pin.dart';
...
class Context implements IContext
{
  ...
  IInjector _injector = new Injector();
  ...
  void _setup()
  {
    _injector.mapToValue(IInjector, _injector);
    _injector.mapToValue(IContext,this);
  ...
  void removeChildren()
  {
    _children.forEach((IContext child) => removeChild(child));
    _children.clear();
  }
}
